...
Route::group([
    ...
    Route::get('/consommations/anomalies/{year}', [ConsommationsController::class, 'getMonthlyAnomaliesForMonth'])->name('consommations.anomalies.month');

    Route::get('/consommations/month/clear/{month}', [ConsommationsController::class, 'clearMonthlyConsumption']);
